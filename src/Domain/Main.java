...
public class Main {
    public static void main(String[] args) {
        ...
        do {
            ...
            try {
                ...
                switch (opcao) {
                    case 1 -> gerenciarMuseusEGalerias(scanner, museuList, galeriaList);
                    case 2 -> gerenciarArtistasEObras(scanner, artistaList, galeriaList, obraList);
                    case 3 -> gerenciarExposicoes(scanner, obraList, exposicaoList);
                    case 4 -> gerenciarVisitantesEAgendamentos(scanner, visitanteList, exposicaoList, agendamentoList);
    ...
    private static void gerenciarMuseusEGalerias(Scanner scanner, ArrayList<Museu> museuList, ArrayList<Galeria> galeriaList) {
    ...
    private static void gerenciarArtistasEObras(Scanner scanner, ArrayList<Artista> artistaList, ArrayList<Galeria> galeriaList, ArrayList<ObraDeArte> obraList) {
    ...
    private static void gerenciarExposicoes(Scanner scanner, ArrayList<ObraDeArte> obraList, ArrayList<Exposicao> exposicaoList) {
    ...
    private static void gerenciarVisitantesEAgendamentos(Scanner scanner, ArrayList<Visitante> visitanteList, ArrayList<Exposicao> exposicaoList, ArrayList<Agendamento> agendamentoList) {
